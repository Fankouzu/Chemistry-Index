/** Periodic table UI + element metadata shared by LearningMode and Formula */

export const CATEGORY_STYLES = {
  'reactive-nonmetal': {
    colorClass:
      'bg-yellow-50 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400 border-yellow-200 dark:border-yellow-800 hover:bg-yellow-100 dark:hover:bg-yellow-900/50',
    activeClass: 'bg-yellow-500 text-white border-yellow-600 shadow-sm',
    disabledClass:
      'bg-yellow-50/40 dark:bg-yellow-900/20 text-yellow-700/40 dark:text-yellow-400/40 border-yellow-200/40 dark:border-yellow-800/40 hover:bg-yellow-50/60 dark:hover:bg-yellow-900/30',
  },
  'alkali-metal': {
    colorClass:
    ...
    disabledClass:
      'bg-red-50/40 dark:bg-red-900/20 text-red-700/40 dark:text-red-400/40 border-red-200/40 dark:border-red-800/40 hover:bg-red-50/60 dark:hover:bg-red-900/30',
  },
  'alkaline-earth-metal': {
    ...
    disabledClass:
      'bg-orange-50/40 dark:bg-orange-900/20 text-orange-700/40 dark:text-orange-400/40 border-orange-200/40 dark:border-orange-800/40 hover:bg-orange-50/60 dark:hover:bg-orange-900/30',
  },
  'transition-metal': {
    colorClass:
    ...
    disabledClass:
      'bg-blue-50/40 dark:bg-blue-900/20 text-blue-700/40 dark:text-blue-400/40 border-blue-200/40 dark:border-blue-800/40 hover:bg-blue-50/60 dark:hover:bg-blue-900/30',
  },
  'post-transition-metal': {
    colorClass:
      'bg-cyan-50 dark:bg-cyan-900/30 text-cyan-700 dark:text-cyan-400 border-cyan-200 dark:border-cyan-800 hover:bg-cyan-100 dark:hover:bg-cyan-900/50',
    activeClass: 'bg-cyan-500 text-white border-cyan-600 shadow-sm',
    disabledClass:
      'bg-cyan-50/40 dark:bg-cyan-900/20 text-cyan-700/40 dark:text-cyan-400/40 border-cyan-200/40 dark:border-cyan-800/40 hover:bg-cyan-50/60 dark:hover:bg-cyan-900/30',
  },
  metalloid: {
    colorClass:
    ...
    disabledClass:
      'bg-teal-50/40 dark:bg-teal-900/20 text-teal-700/40 dark:text-teal-400/40 border-teal-200/40 dark:border-teal-800/40 hover:bg-teal-50/60 dark:hover:bg-teal-900/30',
  },
  halogen: {
    colorClass:
    ...
    disabledClass:
      'bg-purple-50/40 dark:bg-purple-900/20 text-purple-700/40 dark:text-purple-400/40 border-purple-200/40 dark:border-purple-800/40 hover:bg-purple-50/60 dark:hover:bg-purple-900/30',
  },
  'noble-gas': {
    colorClass:
      'bg-slate-50 dark:bg-slate-900/30 text-slate-700 dark:text-slate-400 border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-900/50',
    activeClass: 'bg-slate-500 text-white border-slate-600 shadow-sm',
    disabledClass:
      'bg-slate-50/40 dark:bg-slate-900/20 text-slate-700/40 dark:text-slate-400/40 border-slate-200/40 dark:border-slate-800/40 hover:bg-slate-50/60 dark:hover:bg-slate-900/30',
  },
} as const;

export type ElementCategory = keyof typeof CATEGORY_STYLES;

/** Text colors for formula symbols (same hues as periodic table labels) */
export const CATEGORY_FORMULA_TEXT: Record<ElementCategory, string> = {
  'reactive-nonmetal': 'text-yellow-700 dark:text-yellow-400',
  'alkali-metal': 'text-red-700 dark:text-red-400',
  'alkaline-earth-metal': 'text-orange-700 dark:text-orange-400',
  'transition-metal': 'text-blue-700 dark:text-blue-400',
  'post-transition-metal': 'text-cyan-700 dark:text-cyan-400',
  metalloid: 'text-teal-700 dark:text-teal-400',
  halogen: 'text-purple-700 dark:text-purple-400',
  'noble-gas': 'text-slate-700 dark:text-slate-400',
};
...
export const ELEMENT_INFO: Record<string, ElementRecord> = {
...
export const PERIODIC_TABLE_POSITIONS: Record<string, { col: number; row: number }> = {
  H: { col: 1, row: 1 },
  He: { col: 18, row: 1 },
  Li: { col: 1, row: 2 },
  Be: { col: 2, row: 2 },
